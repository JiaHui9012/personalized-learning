...
export default function ViewModulesNestedGrid(props) {
    ...
    return (
      <React.Fragment>
        {props.firstModule != undefined ? (
          <Grid item xs>
            <Paper className={classes.paper}>
              <b>{props.firstModule.moduleName}</b>
              <br /> {props.firstModule.numberOfLessons} {" lessons"} <br />{" "}
              <Link
                to={{ pathname: "/viewmoduleinfo/" + props.firstModule.id }}
                style={{ color: "#014444", textDecoration: "none" }}
              >
                {" "}
                <b>Click to view Lessons</b>
              </Link>
            </Paper>
          </Grid>
        ) : (
        ...
        {props.secondModule != undefined ? (
          <Grid item xs>
            <Paper className={classes.paper}>
              ...
              <Link
                to={{ pathname: "/viewmoduleinfo/" + props.secondModule.id }}
                style={{ color: "#014444", textDecoration: "none" }}
              >
                {" "}
                <b>Click to view Lessons</b>
        ...
        {props.thirdModule != undefined ? (
          <Grid item xs>
            <Paper className={classes.paper}>
              <b>{props.thirdModule.moduleName}</b>
              <br /> {props.thirdModule.numberOfLessons} {" lessons"} <br />{" "}
              <Link
                to={{ pathname: "/viewmoduleinfo/" + props.thirdModule.id }}
                style={{ color: "#014444", textDecoration: "none" }}
              >
                {" "}
                <b>Click to view Lessons</b>

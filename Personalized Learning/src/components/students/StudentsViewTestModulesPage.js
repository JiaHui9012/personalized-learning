...
import AssessmentModulesNestedGrid from "components/students/AssessmentModulesNestedGrid";
...
class StudentsViewTestModulesPage extends Component {
  render() {
      ...
      return (
        <div>
          <MainContainer className={classes.root}>
            ...
            <SubContainer>
              <AssessmentModulesNestedGrid modules = {modules} />
            </SubContainer>
          </MainContainer>
          <Footer />
        </div>

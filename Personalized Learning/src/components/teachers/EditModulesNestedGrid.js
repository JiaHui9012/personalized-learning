...
export default function TeachersEditModulesNestedGrid(props) {
        ...
        {props.firstModule != undefined ? (
          <Grid item xs>
            <Paper className={classes.paper}>
              ...
              <Link
                to={{ pathname: "/editmodule/" + props.firstModule.id }}
        ...
        {props.secondModule != undefined ? (
          <Grid item xs>
            <Paper className={classes.paper}>
              ...
              <Link
                to={{ pathname: "/editmodule/" + props.secondModule.id }}
                style={{ color: "#014444", textDecoration: "none" }}
              >
                Click to edit module{" "}
              </Link>
        ...
        {props.thirdModule != undefined ? (
          <Grid item xs>
            <Paper className={classes.paper}>
              ...
              <Link
                to={{ pathname: "/editmodule/" + props.thirdModule.id }}
                style={{ color: "#014444", textDecoration: "none" }}
              >
                Click to edit module{" "}
              </Link>
